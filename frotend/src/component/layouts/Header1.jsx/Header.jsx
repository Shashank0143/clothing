                ...
                <li className="dropdown">
                  ...
                  {isDropdownOpen && (
                    <ul className="dropdown-content">
                      <li><Link to="#">Men Suits</Link></li>
                      <li><Link to="#">Women Suits</Link></li>
                      <li><Link to="#">Blazers</Link></li>
                      <li><Link to="#">T-Shirts</Link></li>
                      <li><Link to="#">Formals</Link></li>
                      <li><Link to="#">Pajamas</Link></li>
                      <li><Link to="#">Jodhpuri Suits</Link></li>
                      <li><Link to="#">Kurta Set</Link></li>
                      <li><Link to="#">Sherwani</Link></li>
                      <li><Link to="#">Shirts & Trousers</Link></li>
                      <li><Link to="#">HighWaist Trousers</Link></li>
                    </ul>
                  )}
                </li>
                <li>
